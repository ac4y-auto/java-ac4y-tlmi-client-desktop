...
public class ListViewObjectArrayGenericAdapter extends ArrayAdapter<Object> {

    public ListViewObjectArrayGenericAdapter(Context context, int resource, List<Object> list) {
